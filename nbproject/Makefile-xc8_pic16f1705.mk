...
ifeq "$(wildcard nbproject/Makefile-local-xc8_pic16f1705.mk)" "nbproject/Makefile-local-xc8_pic16f1705.mk"
include nbproject/Makefile-local-xc8_pic16f1705.mk
endif
endif
...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c interrupts.c main.c system.c user.c MISC.c UART.c PS_2.c FLASH.c ADC.c Timer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/MISC.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/PS_2.p1 ${OBJECTDIR}/FLASH.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/Timer.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/system.p1.d ${OBJECTDIR}/user.p1.d ${OBJECTDIR}/MISC.p1.d ${OBJECTDIR}/UART.p1.d ${OBJECTDIR}/PS_2.p1.d ${OBJECTDIR}/FLASH.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/Timer.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/system.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/MISC.p1 ${OBJECTDIR}/UART.p1 ${OBJECTDIR}/PS_2.p1 ${OBJECTDIR}/FLASH.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/Timer.p1

# Source Files
SOURCEFILES=configuration_bits.c interrupts.c main.c system.c user.c MISC.c UART.c PS_2.c FLASH.c ADC.c Timer.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-xc8_pic16f1705.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC_IR_RF_Bluetooth_Home_Automation.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/PS_2.p1: PS_2.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/PS_2.p1.d 
	@${RM} ${OBJECTDIR}/PS_2.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/PS_2.p1  PS_2.c 
	@-${MV} ${OBJECTDIR}/PS_2.d ${OBJECTDIR}/PS_2.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/PS_2.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/xc8_pic16f1705
	${RM} -r dist/xc8_pic16f1705
